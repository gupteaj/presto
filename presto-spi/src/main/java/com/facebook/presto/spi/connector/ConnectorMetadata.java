...
public interface ConnectorMetadata
{
     ...
     * Returns a table handle for the specified table name, or null if the connector does not contain the table.
     */
    default ConnectorTableHandle getTableHandle(ConnectorSession session, SchemaTableName tableName, Optional<Type> timeTravelType, Optional<Object> timeTravelExpression)
    {
        throw new PrestoException(NOT_SUPPORTED, "This connector does not support time travel expression");
    }
