        ...
        extends AbstractTestQueryFramework
{
    ...
    public static final String tab1 = "test_time_travel_tab1";
    public static final String tab2 = "test_time_travel_tab2";
    ...
    @Test
    public void testTimeTravelBasic()
    {
    ...
    @Test
    public void testTimeTravelMisc()
    {
        // Joins, CTE, create table as, union/intersect/except, subquery
    ...
    @Test
    public void testTimeTravelErrors()
    {
        assertQueryFails("SELECT desc FROM " + tableName2 + " FOR VERSION AS OF 100", ".* Type integer is invalid. Supported time travel expression type is BIGINT");
        assertQueryFails("SELECT desc FROM " + tableName2 + " FOR VERSION AS OF 'bad'", ".* Type varchar\\(3\\) is invalid. Supported time travel expression type is BIGINT");
        assertQueryFails("SELECT desc FROM " + tableName2 + " FOR VERSION AS OF CURRENT_DATE", ".* Type date is invalid. Supported time travel expression type is BIGINT");
        assertQueryFails("SELECT desc FROM " + tableName2 + " FOR VERSION AS OF CURRENT_TIMESTAMP", ".* Type timestamp with time zone is invalid. Supported time travel expression type is BIGINT");
        ...
        assertQueryFails("SELECT desc FROM " + tableName2 + " FOR VERSION AS OF NULL", "Time travel AS OF expression cannot be NULL for .*");
        ...
        assertQueryFails("SELECT desc FROM " + tableName2 + " FOR TIMESTAMP AS OF 100", ".* Type integer is invalid. Supported time travel expression type is Timestamp with Time Zone.");
        assertQueryFails("SELECT desc FROM " + tableName2 + " FOR TIMESTAMP AS OF 'bad'", ".* Type varchar\\(3\\) is invalid. Supported time travel expression type is Timestamp with Time Zone.");
        ...
        assertQueryFails("SELECT desc FROM " + tableName2 + " FOR TIMESTAMP AS OF NULL", "Time travel AS OF expression cannot be NULL for .*");
        assertQueryFails("SELECT desc FROM " + tableName2 + " FOR TIMESTAMP AS OF TIMESTAMP " + "'" + tab2Timestamp1 + "' - INTERVAL '1' MONTH", "No version history table \"test_tt_schema\".\"test_time_travel_tab2\" at or before.*");
        assertQueryFails("SELECT desc FROM " + tableName2 + " FOR TIMESTAMP AS OF CAST ('2023-01-01' AS TIMESTAMP WITH TIME ZONE)", "No version history table \"test_tt_schema\".\"test_time_travel_tab2\" at or before 2022-12-31.*");
        assertQueryFails("SELECT desc FROM " + tableName2 + " FOR TIMESTAMP AS OF CAST ('2023-01-01' AS TIMESTAMP)", ".* Type timestamp is invalid. Supported time travel expression type is Timestamp with Time Zone.");
        assertQueryFails("SELECT desc FROM " + tableName2 + " FOR TIMESTAMP AS OF CAST ('2023-01-01' AS DATE)", ".* Type date is invalid. Supported time travel expression type is Timestamp with Time Zone.");
        assertQueryFails("SELECT desc FROM " + tableName2 + " FOR TIMESTAMP AS OF CURRENT_DATE", ".* Type date is invalid. Supported time travel expression type is Timestamp with Time Zone.");
        assertQueryFails("SELECT desc FROM " + tableName2 + " FOR TIMESTAMP AS OF TIMESTAMP '2023-01-01 00:00:00.000'", ".* Type timestamp is invalid. Supported time travel expression type is Timestamp with Time Zone.");
    }
}
