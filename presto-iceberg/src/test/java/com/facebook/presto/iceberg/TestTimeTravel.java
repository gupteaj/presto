        ...
        extends AbstractTestQueryFramework
{
    ...
    {
        assertQueryFails("SELECT desc FROM " + tableName2 + " FOR VERSION AS OF 100", "Unsupported type for table version: integer");
        assertQueryFails("SELECT desc FROM " + tableName2 + " FOR VERSION AS OF 'bad'", "Unsupported type for table version: varchar\\(3\\)");
        assertQueryFails("SELECT desc FROM " + tableName2 + " FOR VERSION AS OF CURRENT_DATE", "Unsupported type for table version: date");
        assertQueryFails("SELECT desc FROM " + tableName2 + " FOR VERSION AS OF CURRENT_TIMESTAMP", "Unsupported type for table version: timestamp with time zone");
        ...
        assertQueryFails("SELECT desc FROM " + tableName2 + " FOR VERSION AS OF NULL", "Pointer value cannot be NULL for FOR VERSION AS OF null");
        ...
        assertQueryFails("SELECT desc FROM " + tableName2 + " FOR TIMESTAMP AS OF 100", ".* Type integer invalid. Temporal pointers must be of type Timestamp, Timestamp with Time Zone, or Date.");
        assertQueryFails("SELECT desc FROM " + tableName2 + " FOR TIMESTAMP AS OF 'bad'", ".* Type varchar\\(3\\) invalid. Temporal pointers must be of type Timestamp, Timestamp with Time Zone, or Date.");
        ...
        assertQueryFails("SELECT desc FROM " + tableName2 + " FOR TIMESTAMP AS OF NULL", "Pointer value cannot be NULL for FOR TIMESTAMP AS OF null");
        ...
        assertQueryFails("SELECT desc FROM " + tableName2 + " FOR TIMESTAMP AS OF CAST ('2023-01-01' AS TIMESTAMP)", "Unsupported type for temporal table version: timestamp");
        assertQueryFails("SELECT desc FROM " + tableName2 + " FOR TIMESTAMP AS OF CAST ('2023-01-01' AS DATE)", "Unsupported type for temporal table version: date");
        assertQueryFails("SELECT desc FROM " + tableName2 + " FOR TIMESTAMP AS OF CURRENT_DATE", "Unsupported type for temporal table version: date");
        assertQueryFails("SELECT desc FROM " + tableName2 + " FOR TIMESTAMP AS OF TIMESTAMP '2023-01-01 00:00:00.000'", "Unsupported type for temporal table version: timestamp");
    }
}
